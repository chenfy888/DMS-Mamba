...
parser.add_argument('--exp', type=str, default='mmr_mamba', help='model_name')
parser.add_argument('--max_iterations', type=int, default=100000, help='maximum epoch number to train')
parser.add_argument('--batch_size', type=int, default=4, help='batch_size per gpu')
parser.add_argument('--base_lr', type=float, default=0.0005, help='maximum epoch numaber to train')
...
parser.add_argument('--model_name', type=str, default='mmr_mamba', help='model_name')
    ...
    if args.phase == 'train':
        ...
        for epoch_num in tqdm(range(max_epoch), ncols=70):
            ...
            for i_batch, (pd, pdfs, _) in enumerate(trainloader):
                ...
                # 形式消融实验（输入T1欠采样+T2全采样）
                                       
                t1_in, t1, t2_in, t2 = pd[0].unsqueeze(1).cuda(), pd[1].unsqueeze(1).cuda(), \
