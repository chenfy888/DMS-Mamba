...
# try:
#     from mamba_ssm.ops.selective_scan_interface import selective_scan_fn, mamba_inner_fn, bimamba_inner_fn, mamba_inner_fn_no_out_proj # type: ignore
# except ImportError:
...
try:
    from mamba_ssm.ops.selective_scan_interface import (
        ...
        mamba_inner_fn,
        bimamba_inner_fn,
        mamba_inner_fn_no_out_proj,  # type: ignore
    )
except ImportError as e:
    print(f"[⚠️ Warning] Failed to import selective_scan_interface: {e}")
