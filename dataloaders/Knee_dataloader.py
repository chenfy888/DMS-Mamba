...
class KneeDataset(data.Dataset):
    def __init__(self, kspace_refine, kspace_round, base_dir=None, split='train', MRIDOWN='4X', \
        ...
        self.cur_path = '/home/chenfurong/CODE2025/MMR-Mamba/MMR-Mamba-main/dataloaders/'
        self.csv_file = os.path.join(self.cur_path, "singlecoil_" + self.mode + "_split_less.csv")  # _2volume
        
        self.data_root = '/public/home/chenfurong/2025data/fastmri_knee/'
    ...
    def __getitem__(self, idx):
        ...
        # fig.savefig('/home/chenfurong/CODE2025/MMR-Mamba/MMR-Mamba-main/test_images/pdfs_sub.png', bbox_inches='tight', pad_inches=0)
        
        # fig = plt.figure()
        # plt.axis('off')
        # plt.imshow(pdfs_sample[1], cmap = 'gray')
        # fig.savefig('/home/chenfurong/CODE2025/MMR-Mamba/MMR-Mamba-main/test_images/pdfs_target.png', bbox_inches='tight', pad_inches=0)

        # fig = plt.figure()
        # plt.axis('off')
        # plt.imshow(pd_sample[0], cmap = 'gray')
        # fig.savefig('/home/chenfurong/CODE2025/MMR-Mamba/MMR-Mamba-main/test_images/pd_sub.png', bbox_inches='tight', pad_inches=0)
        
        # fig = plt.figure()
        # plt.axis('off')
        # plt.imshow(pd_sample[1], cmap = 'gray')
        # fig.savefig('/home/chenfurong/CODE2025/MMR-Mamba/MMR-Mamba-main/test_images/pd_target.png', bbox_inches='tight', pad_inches=0)
