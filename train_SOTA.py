...
parser.add_argument('--exp', type=str, default='MyModelX1_lr001_4X_brast', help='model_name')
...
parser.add_argument('--model_name', type=str, default='mymodelX1', help='model_name')
...
snapshot_path = "/home/chenfurong/CODE2025/modelsave/" + args.exp + "/"
...
if __name__ == "__main__":
    ...
    logging.info(f"Trainable params: {n_parameters/1e6:.3f} M ({n_parameters} params)")
    ...
    # logging.info(f"Total params:      {n_params_total/1e6:.3f} M ({n_params_total} params)")
    ...
    # print('FLOPs',macs)
    # print('params',params)
    train_data_path = os.path.join(args.root_path, 'train4X/')
    ...
    if args.phase == 'train':
        ...
        logging.info(f"max_epoch: {max_epoch}, iters_per_epoch: {len(trainloader)}, batch_size: {batch_size}")
        logging.info(f"base_lr: {base_lr}, optimizer: AdamW, weight_decay: 1e-4")
        ...
        for epoch_num in tqdm(range(max_epoch), ncols=70):
            ...
            if t2_psnr > best_status['T2_PSNR']:
                ...
                logging.info(f"New Best Network")
